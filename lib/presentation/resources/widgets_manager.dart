...
class AppTextFormField extends StatefulWidget {
  ...
  AppTextFormField(this._controller,
      {Key? key, this.hint = '', this.isPassword = false, this.label = "",this.showBorder = false})
      : super(key: key);
  ...
  AlertDialog alert=AlertDialog(
    content:  Row(
      children: [
        ...
        Container(margin: const EdgeInsets.only(left: AppMargin.m10),child:const Text(AppStrings.loading )),
      ],),
  );
